...
>
> This copy was written by `surveyjs-cli 0.2.0` from [surveyjs/surveyjs-skills](https://github.com/surveyjs/surveyjs-skills) and describes those versions. After upgrading SurveyJS, re-run `npx surveyjs-cli@latest init-agents`. If a documented API is missing at runtime, check the typings inside the installed package before assuming the skill is wrong.
<!-- surveyjs:pinned:end -->
